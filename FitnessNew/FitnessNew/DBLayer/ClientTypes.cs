...
namespace FitnessProject.DBLayer
{
    public class ClientTypes
    {
        ...
        {
                DataTable dt = ZFort.DB.Execute.ExecuteString_DataTable("SELECT * FROM ClientTypes");

                ArrayList al = new ArrayList();

                foreach (DataRow dr in dt.Rows)
                {
                    DBLayer.ClientTypes.Details det = new DBLayer.ClientTypes.Details();
        ...
        public static DBLayer.ClientTypes.Details GetDetails(int id)
        {
            ...
            DBLayer.ClientTypes.Details det = new Details();
